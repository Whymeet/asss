...
return [
    ...
    // ==========================================
    "bigovka"         => 1,    // биговка
    "corner_radius"   => 0.3,  // скругление за угол
    "perforation"     => 0.5,  // перфорация
    "drill"           => 0.4,  // сверление
    "numbering_small" => 0.5,  // нумерация (тираж <= 1000)
    "numbering_large" => 0.3,  // нумерация (тираж > 1000)
    ...
    "canvas_large_per_m2"    => 2700, // руб/м² для холстов > 100 см
    "podramnik_large_per_m2" => 1900, // руб/м² для подрамников > 100 см
