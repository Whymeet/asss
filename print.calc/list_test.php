...
require_once __DIR__ . '/lib/Calculators/ListCalculator.php';

use PrintCalc\Core\PriceConfig;
use PrintCalc\Core\Constants\PrintTypes;
use PrintCalc\Calculators\ListCalculator;

// Создаем конфигурацию
$config = new PriceConfig();

// Создаем калькулятор
$calculator = new ListCalculator($config);
...
$params = [
    ...
    'cornerRadius' => 2,           // Скругление 2 углов
